#!/usr/bin/env python3
r"""
Audit formal manuscript items in Part IV for local `\lean{...}` tags.
"""
...
REPORT_MD = ARTIFACTS / "part_iv_tag_audit.md"
REPORT_JSON = ARTIFACTS / "part_iv_tag_audit.json"
...
def write_markdown(report: dict[str, object]) -> None:
    ...
    lines: list[str] = []
    lines.append("# Part IV Tag Audit")
    lines.append("")
    lines.append("This report checks formal manuscript items in Part IV")
