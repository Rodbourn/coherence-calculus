#!/usr/bin/env python3
r"""
Audit theorem-like manuscript items in Part III for local `\lean{...}` tags.
"""
...
REPORT_MD = ARTIFACTS / "part_iii_tag_audit.md"
REPORT_JSON = ARTIFACTS / "part_iii_tag_audit.json"
...
def write_markdown(report: dict[str, object]) -> None:
    ...
    lines: list[str] = []
    lines.append("# Part III Tag Audit")
    lines.append("")
    lines.append("This report checks formal manuscript items in Part III")
    ...
    for section in report["sections_detail"]:
        ...
        for item in missing:
            ...
            lines.append(f"- line {item['line_number']}: `{item['env_type']}`{label_suffix}")
        lines.append("")
